...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item The following lowerCamelCase options of the \texttt{impexp}
			CLI command have been marked as \textbf{deprecated}:
	\end{itemize}
...
impexp:export --save-files-outside-export-file
