...
\begin{frame}[fragile]
	...
	\framesubtitle{Attribut «~Channel~» pour l'injection du Logger (PHP v8)}
	...
	\begin{itemize}
		...
		\item Elle permet aux développeurs d'ajouter des métadonnées aux classes, méthodes, variables, etc.
		\item Ils peuvent contrôler le nom du composant qu'un Logger injecté sera créé avec
