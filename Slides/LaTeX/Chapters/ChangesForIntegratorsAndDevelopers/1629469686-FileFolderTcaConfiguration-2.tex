...
\end{lstlisting}
		...
		\item Read more:
			...
			\begin{itemize}
				...
				\item Further details in the \href{https://docs.typo3.org/c/typo3/cms-core/master/en-us/Changelog/11.4/Feature-94406-OverrideFileFolderTCAConfigurationWithTSconfig.html}{changelog}
		\end{itemize}
